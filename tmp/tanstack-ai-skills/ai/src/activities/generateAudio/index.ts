...
export type AudioProviderOptions<TAdapter> =
  TAdapter extends AudioAdapter<any, any> ? TAdapter["~types"]["providerOptions"] : object;
 ...
 */
export type AudioActivityResult<TStream extends boolean = false> = TStream extends true
...
export function generateAudio<
  TAdapter extends AudioAdapter<string, AudioProviderOptions<TAdapter>>,
  TStream extends boolean = false,
>(options: AudioActivityOptions<TAdapter, TStream>): AudioActivityResult<TStream> {
  if (options.stream) {
    return streamGenerationResult(() => runGenerateAudio(options)) as AudioActivityResult<TStream>;
  }
...
async function runGenerateAudio<
  TAdapter extends AudioAdapter<string, AudioProviderOptions<TAdapter>>,
>(options: AudioActivityOptions<TAdapter, boolean>): Promise<AudioGenerationResult> {
...
export function createAudioOptions<
  TAdapter extends AudioAdapter<string, AudioProviderOptions<TAdapter>>,
  TStream extends boolean = false,
>(options: AudioActivityOptions<TAdapter, TStream>): AudioActivityOptions<TAdapter, TStream> {
  return options;
}

// Re-export adapter types
export type { AudioAdapter, AudioAdapterConfig, AnyAudioAdapter } from "./adapter";
