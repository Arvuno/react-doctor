 ...
 * ```
 */
export function untilFinishReason(stopReasons: Array<string>): AgentLoopStrategy {
 ...
 * ```
 */
export function combineStrategies(strategies: Array<AgentLoopStrategy>): AgentLoopStrategy {
  return (state) => {
